<template>
    ...
    <div class="container">
        ...
        <article v-for="post , index in articles" :key="index" style="border:solid">
            ...
            <div class="d-flex" style="background-color:lightgray">
                <button style="margin-left:5px; text-align:center"><img style="margin-right: 5px;" src="./../../heart.png" />Like</button>
                ...
                <button style="margin-left: 30px;"><img style="margin-right: 5px;" src="./../../comment.png" />Commenter</button>
